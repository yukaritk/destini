...
//TODO: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory(int numberChoice) {
    if (numberChoice == 1 && _storyNumber == 0) {
      _storyNumber = 2;
    } else if (numberChoice == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (numberChoice == 1 && _storyNumber == 1) {
      _storyNumber = 2;
    } else if (numberChoice == 2 && _storyNumber == 1) {
      _storyNumber = 3;
    } else if (numberChoice == 1 && _storyNumber == 2) {
      _storyNumber = 5;
    } else if (numberChoice == 2 && _storyNumber == 2) {
      _storyNumber = 4;
